package edu.ucla.library.dep.generateMods.model;
...
public class CsvBean {
	...
	/*
	 * public MultiValuedMap<String, String> getTracks() { return tracks; }
	 * 
	 * 
	 * public void setTracks(MultiValuedMap<String, String> tracks) { this.tracks =
	 * tracks; }
	 */

	// @CsvBindAndJoinByName(column = "Track[0-9]+", elementType = String.class,
